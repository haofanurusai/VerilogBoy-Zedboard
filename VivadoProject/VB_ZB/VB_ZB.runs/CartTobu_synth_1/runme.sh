...
HD_PWD='C:/Users/Tom/VB_ZB/VB_ZB.runs/CartTobu_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CartTobu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CartTobu.tcl
